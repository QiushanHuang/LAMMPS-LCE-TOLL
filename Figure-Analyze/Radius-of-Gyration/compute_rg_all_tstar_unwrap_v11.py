...
# ============================================
def collect_all_rg_data(root_dir, selected_types={1, 2}, max_workers=None):
    """
...
def plot_temperature_panel(ax, all_data, tail_points=3000):
...
if __name__ == "__main__":
    ...
    dt = args.dt
    analysis_name = root_dir.name or str(root_dir)
